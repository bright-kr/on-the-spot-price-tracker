...
Info  : https://brightdata.co.kr/products/insights/price-tracker/on-the-spot
"""
...
# https://brightdata.co.kr/products/web-scraper/on-the-spot
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your On the Spot scraper at: https://brightdata.co.kr/products/web-scraper/on-the-spot\n"
